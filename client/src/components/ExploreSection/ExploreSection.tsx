...
const ExploreSection: React.FC = () => { 
  ...
  const navigateToMasterVilla = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
  ...
  return (
    ...
    <div className="sticky-circle_wrap">
      ...
      <div data-w-id="761d741a-9dc7-6304-8c5c-83152849a839" className="text-wrapper">
        <div className="max-width-500">
          ...
          <div className="_2-buttons-wrapper">
            <a href="/master-villa" target="_blank" className="primary-button w-inline-block" onClick={navigateToMasterVilla}>
            ...
            <a data-lenis-stop="" data-w-id="8cf4b209-d6f2-1fc8-368f-718115fb2012" href="#" 
        ...
        <div data-w-id="772091d7-6255-7f23-9153-3b3e1a2122e2" className="overlay-gradient"></div>
      </div>
    </div>
  </div>
  )
