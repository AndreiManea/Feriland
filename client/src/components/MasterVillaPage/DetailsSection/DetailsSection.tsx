          ...
          <GridSection>
            ...
            <IconDetailsWrapper>
              ...
              <IconDetailsContainer>
                ...
                />
                <IconDetailsTextContainer>
                  <BoldText>Free Cancelation before ( dynamic date )</BoldText>
                </IconDetailsTextContainer>
              </IconDetailsContainer>
            </IconDetailsWrapper>
            <MenuDivider />
                ...
                <TabContent>
                  ...
                  >
                    <Content>
                      <Description>
                        <TextRegular>
                          Galbino is a stunning 16th century castle in the midst
                          of nature just a few kilometres from the enchanting
                          village of Anghiari.
                          <br />
                          On a hill surrounded by woods and fields, Galbino
                          Castle is a private and exclusive place to relax,
                          explore nature, visit the cultural attractions of the
                          area and enjoy the Tuscan delights of food and wine.
                          The castle is naturally cool thanks to its thick walls
                          and features an infinity pool with spectacular
                          countryside views...
                        </TextRegular>
                        <BoldTextLarge>
                        ...
                        <TextRegular>
                          ...
                          billiards and a ping pong table, a large kitchen with
                          a fireplace, two dining rooms, a library, a living
                          room with walls covered in frescos and a small chapel
                          which is still consecrated.
                          <br />
                          <br />
                          The castle is surrounded by a large garden, also for
                          the exclusive use of guests, housing the spectacular
                          infinity pool overlooking the Tuscan countryside.A few
                          steps from the pool there is a comfortable changing
                          room with a bathroom and shower.
                        </TextRegular>
                      </Description>
                    </Content>
                  </ContentWrapper>
